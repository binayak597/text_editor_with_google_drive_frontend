...
const Home = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div 
        className="px-6 py-2 text-white rounded-lg flex items-center gap-2 shadow-lg border-2 border-gray-300 cursor-pointer"
        onClick={handleGoogleAuth}
      >
        <svg className="w-8 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 326667 333333" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd">
